...
namespace Integration
{
    public class IAPService : MonoBehaviour, IDetailedStoreListener 
    {
        ...
        private DiamondsService _diamondsService;
        
        public GameObject SubscriptionCanvas => _subscriptionCanvas;
        
        [Inject]
        private void Construct(AdMobController adMobController, DiamondsService diamondsService)
        {
